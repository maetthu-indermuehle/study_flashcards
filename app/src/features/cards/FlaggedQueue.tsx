...
export default function FlaggedQueue({ cards, tags }: Props) {
  ...
  return (
    <div>
      ...
      {/* Card identifier */}
      {card.originalId && (
        <p className="mb-4 font-mono text-xs text-slate-400 dark:text-slate-500">{card.originalId}</p>
      )}
      ...
      <div className="mt-6 border-t border-slate-100 dark:border-slate-700 pt-4">
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="rounded-md border border-emerald-300 dark:border-emerald-700 bg-emerald-50 dark:bg-emerald-900/20 px-4 py-2 text-sm font-medium text-emerald-700 dark:text-emerald-400 transition hover:bg-emerald-100 dark:hover:bg-emerald-900/35"
          >
            Save & clear flag
          </button>
          <button
            ...
            className="rounded-md border border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-900/20 px-4 py-2 text-sm font-medium text-amber-700 dark:text-amber-400 transition hover:bg-amber-100 dark:hover:bg-amber-900/35"
          >
            Save & keep flagged
          </button>
          <button
            type="button"
            onClick={onSkip}
            className="rounded-md border border-slate-300 dark:border-slate-600 px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 transition hover:bg-slate-50 dark:hover:bg-slate-700"
          >
            Skip (no save)
          </button>
        </div>
